...
export function MarqueeBar() {
  ...
  return (
    <div className="overflow-hidden border-y border-black/20 bg-gold-500 py-2.5">
      <div className="flex w-max animate-[marquee_26s_linear_infinite] gap-8 whitespace-nowrap">
        {[...track, ...track].map((item, i) => (
          <span
            key={`${item}-${i}`}
            className="font-display text-xs font-semibold uppercase tracking-[0.3em] text-ink-950"
          >
