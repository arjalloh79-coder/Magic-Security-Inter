...
import { EquipmentSpotlight } from './EquipmentSpotlight'
    ...
    <section id="equipements" className="relative bg-ink-950 py-20 sm:py-28">
      <div ref={ref} className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-stretch">
          <div className="reveal relative aspect-square overflow-hidden border border-white/10 lg:aspect-auto">
            <EquipmentSpotlight className="h-full w-full" title={t.equipment.title} />
          </div>
